...
- **General deliverability concepts, bounce management, compliance** → Read `resources/frameworks/deliverability-guide.md`
- **Advanced strategy, TAM reuse, Golden ICP, benchmarks** → Read `resources/frameworks/cold-email-mastery.md`
...
- **13 named frameworks with templates** → Read `resources/copywriting/copywriting-frameworks.md`
- **Core philosophy and email component rules** → Read `resources/copywriting/copywriting-principles.md`
- **Sequence structure and variations** → Read `resources/copywriting/copywriting-sequences.md`
- **E-commerce vertical playbook** → Read `resources/copywriting/copywriting-ecom-playbook.md`
- **Growth Today playbook: 3 value prop styles, 3 preview patterns, ready-to-deploy sequences, pain-point angles** → Read `resources/copywriting/growthtoday-playbook_v2.md`
...
- **Tool comparison, multi-channel setup, Clay integration** → Read `resources/tooling/sequencing-tools.md`
