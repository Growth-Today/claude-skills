...
### Step 1: Build a List in Store Leads
...
- Check if they run Meta or TikTok ads
- Add average price point, product category, and other relevant brand details
- Add revenue and traffic estimates

Store Leads + Clay covers reach, relevance, and speed. Use Apollo to extend the company or contact list if needed.

### Step 3: Waterfall Enrichment

For email finding, use this waterfall:

Clay Find Contacts → Apollo → LeadMagic → Prospeo → Findymail
