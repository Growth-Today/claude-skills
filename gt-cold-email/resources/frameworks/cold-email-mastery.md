...
**4 emails per sequence (GT standard):**
- Email 1 = always best performance (80% of positive replies)
- Email 2 & 3 = diminishing returns but meaningful lift
- Email 4 = final touch, goal is any reply
- For full structure and timing → see `resources/copywriting/copywriting-sequences.md`
...
GT standard is 4 emails. For the full sequence structure, email-by-email goals, timing (Day 0/3/6/10), thread rules, value prop rotation, and breakup email variants → read `resources/copywriting/copywriting-sequences.md`. Do not maintain sequence structure here.
