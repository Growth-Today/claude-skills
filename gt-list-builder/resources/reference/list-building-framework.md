...
For the canonical ICP Fit Score (full scoring matrix, 7 criteria with weights, and tier thresholds), see `resources/sub-skills/icp-definition.md`.

**Tiers (canonical):**
- **A-tier (90–100):** Perfect fit, prioritize
- **B-tier (70–89):** Good fit, pursue
- **C-tier (50–69):** Okay fit, nurture
- **D-tier (<50):** Poor fit, disqualify

For the full three-layer decision framework (when to apply ICP Fit Score vs ABM Account Prioritization vs Outreach Matrix), see `resources/reference/scoring-decision-framework.md`.
