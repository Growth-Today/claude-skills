...
Segment and score Leads, Contacts, and Accounts. Read the playbook in full before acting.

| Need | Playbook |
|---|---|
| Fit + Engagement lead scoring | `{SKILL_BASE}/playbooks/build-lead-scoring/playbook.md` |
| Foundational list views & reports | `{SKILL_BASE}/playbooks/build-list-views-and-reports/playbook.md` |
| ICP tier classification | `{SKILL_BASE}/playbooks/create-icp-tiers/playbook.md` |
| Business segment list views | `{SKILL_BASE}/playbooks/create-segment-list-views/playbook.md` |
