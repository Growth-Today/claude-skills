...
Build and run the sales pipeline and forecast. Read the playbook in full before acting.

| Need | Playbook |
|---|---|
| Sales process & Opportunity stages | `{SKILL_BASE}/playbooks/sales-process-and-stages/playbook.md` |
| Lead conversion field mapping | `{SKILL_BASE}/playbooks/lead-conversion-mapping/playbook.md` |
| Products & price books | `{SKILL_BASE}/playbooks/products-and-price-books/playbook.md` |
| Forecasting setup | `{SKILL_BASE}/playbooks/forecasting-setup/playbook.md` |
| Campaigns & influence | `{SKILL_BASE}/playbooks/campaigns-and-influence/playbook.md` |
| Clean opportunity data | `{SKILL_BASE}/playbooks/cleanup-opportunities/playbook.md` |
