...
- Read `{SKILL_BASE}/resources/core/expert-tips.md` for the 6 table rules and 8 AI prompting rules.
- Read `{SKILL_BASE}/resources/core/workflow-patterns.md` for auto-update behavior and run settings.
