...
- **Credit optimization, cost reduction, conditional logic for savings** → Read `{SKILL_BASE}/resources/operations/credit-optimization.md`
- **Data provider rankings, waterfall strategies, buying signals, blocklists** → Read `{SKILL_BASE}/resources/operations/guide.md`
- **58 pre-built templates, quick start packs, workflow catalog** → Read `{SKILL_BASE}/resources/operations/templates.md`
