...
- Read `{SKILL_BASE}/resources/core/core-concepts.md` for Clay table fundamentals.
- Read `{SKILL_BASE}/resources/core/workflow-patterns.md` for lead sourcing patterns and data import methods.
