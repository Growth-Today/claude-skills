...
|----------|-------------|
| `resources/credits-and-pricing.md` | Pricing, plans, credit costs |
| `resources/crm-sync.md` | HubSpot, Salesforce, Pipedrive sync |
...
| `resources/waterfall-enrichment.md` | Waterfall mechanics |
| `resources/core-concepts.md` | Clay fundamentals |
| `resources/workflow-patterns.md` | Import methods, auto-update |
| `resources/templates/clay-enrichment-workflows.md` | 9-step enrichment pipeline |
| `resources/expert-tips.md` | Pro tips |
