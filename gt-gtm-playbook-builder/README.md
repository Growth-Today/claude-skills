...
```bash
npx skills add Growth-Today/claude-skills/gt-gtm-playbook-builder
```

Or copy the `gt-gtm-playbook-builder/` folder into your project's `.claude/skills/` (or `~/.claude/skills/` for global use).

Not sure how to install or use Claude Skills? Full walkthrough here: **https://www.growthtoday.co/claude-skills/gt-gtm-playbook-builder**
...
Best paired with a Clay account (for the signal-detection workflows) and Google Drive (to store the generated playbooks). Related GT skills: `gt-clay-builder`, `gt-buying-signal-sourcer`, `gt-cold-email-writer`.

## Structure

```
gt-gtm-playbook-builder/
