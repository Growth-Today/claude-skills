...
n8n ("nodemation") is a visual workflow automation tool built on Node.js. Build workflows by connecting nodes (like a flowchart) to automate processes. n8n now documents on the order of ~2,864 nodes (400+ integrations plus core, logic, AI, and trigger nodes), and recent versions expose an instance-level MCP server that lets agents build, edit, and validate workflows programmatically.
