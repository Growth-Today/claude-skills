...
For full sequence structure, timing, thread rules, and email content → see `resources/messaging/copywriting-sequences.md`
...
If no reply after the sequence → re-engage according to `resources/sub-skills/re-engagement.md` and `resources/messaging/cold-email-mastery.md`
...
| Skill | Why |
|-------|-----|
| `gt-cold-email-writer` | Main orchestrator — routing and sequence structure |
| `gt-buying-signal-sourcer` | Improve reply rates with better signals |
| `gt-list-builder` | Fix bounce rate issues with better list quality |
