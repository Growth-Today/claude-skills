...
- "Following up"
- Fake RE: threads with no prior email
...
For the full spam trigger word list → see `resources/messaging/email-spam-checker.md`

Run the spam checker on every email before returning it to the user. The spam checker also flags formatting issues (ALL CAPS, multiple links, link shorteners).
