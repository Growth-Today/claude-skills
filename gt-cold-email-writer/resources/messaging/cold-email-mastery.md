...
- For full structure and timing → see `resources/messaging/copywriting-sequences.md`
...
GT standard is 4 emails. For the full sequence structure, email-by-email goals, timing (Day 0/3/6/10), thread rules, value prop rotation, and breakup email variants → read `resources/messaging/copywriting-sequences.md`. Do not maintain sequence structure here.
