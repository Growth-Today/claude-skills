...
Read `{SKILL_BASE}/resources/messaging/atl-btl-messaging.md` — focus on the **Above-the-Line (ATL) Messaging** section for the strategic language guide, decision framework, and fatal mistakes. Ignore the BTL section.
