...
Read `{SKILL_BASE}/resources/messaging/writing-frameworks.md` for all 8 frameworks and Josh Braun principles.
Read `{SKILL_BASE}/resources/templates/email-templates-library.md` for 23 first-touch templates.
Read `{SKILL_BASE}/resources/messaging/growthtoday-playbook_v2.md`
