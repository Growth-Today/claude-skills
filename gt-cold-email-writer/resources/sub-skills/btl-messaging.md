...
Read `{SKILL_BASE}/resources/messaging/atl-btl-messaging.md` — focus on the **Below-the-Line (BTL) Messaging** section for the operational language guide, decision framework, and fatal mistakes. Ignore the ATL section.
