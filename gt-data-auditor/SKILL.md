...
Do NOT fire when:
- The user wants to BUILD a list from scratch ↳ defer to `gt-list-builder`
- The user wants Clay workflow help unrelated to validation ↳ defer to `gt-clay-builder`
- The user wants HubSpot portal admin work unrelated to data quality ↳ defer to `gt-hubspot-admin`
- The user wants cold email copy or sequences ↳ defer to `gt-cold-email-writer`
...
- **gt-gtm-playbook-builder** ↳ Data audit is a precondition. Run this skill first
- **gt-clay-builder** ↳ Use the audit result to scope the Clay table build
- **gt-hubspot-admin** ↳ Dimensions 7 and 8 deeper dive for HubSpot users
- **gt-cold-email-writer** ↳ Dimensions 2 and 9 are preconditions for cold email infra
- **gt-list-builder** ↳ Dimension 1 (Coverage) is what list building feeds
- **gt-buying-signal-sourcer** ↳ Signal-based selling assumes clean data
