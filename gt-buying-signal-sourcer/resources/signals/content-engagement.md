...
- Read `{SKILL_BASE}/resources/core/signal-taxonomy.md` for INBOUND triggers 1-30 (content, events, social engagement)
- Read `{SKILL_BASE}/resources/plays/gtm-plays.md` for Play 11 (Inbound Followers)
