...
- Read `{SKILL_BASE}/resources/core/buying-signals.md` for signal ranking and benchmarks
- Read `{SKILL_BASE}/resources/core/signal-taxonomy.md` for firmographic triggers (Companies that Started Hiring)
- Read `{SKILL_BASE}/resources/plays/gtm-plays.md` for plays 1-3, 5-7 (hiring-related GTM plays)
