...
5. Test one variable at a time on a weekly cadence
...
- Founder / senior-team talking head (authenticity, trust).
- Screen recording / product walkthrough (great for SaaS).
- Client testimonial naming the specific result (not generic praise).
- Problem walkthrough: describe a scenario the buyer recognises, then pivot to the solution.
- Carousel for feature/use-case/logo showcase (MOFU comparison). Carousel + lead form can lift qualified leads at lower CPL.

## The Creative Library System

Build a modular library of hooks, bodies, and CTAs that mix and match. This enables rapid iteration without inventing concepts from scratch each time, and over time becomes a competitive advantage: you learn which hooks work, which CTAs convert, which visual styles resonate. New tests get faster and more likely to win.
...
Creative performance is ultimately capped by the landing page (or Instant Form) it leads to. Message-match the post-click experience to the ad, or a great hook wastes its click (see lead-forms).

## Examples

Example 1: "What creative should I run for B2B on Meta?"
→ Mobile-first, captioned, hook in 3 seconds. Founder talking-head, screen recordings, result-specific testimonials. Build a modular hook/body/CTA library, test 2-4 concepts weekly, one variable at a time, hook first.

Example 2: "My ads were working and suddenly dropped off."
