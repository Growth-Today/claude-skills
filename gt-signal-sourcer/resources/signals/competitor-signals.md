...
- Read `{SKILL_BASE}/resources/core/signal-taxonomy.md` for Category III: Competitors (triggers 8-16)
- Read `{SKILL_BASE}/resources/plays/gtm-plays.md` for Play 8 (Bad Reviews) and Play 11 (Inbound Followers)
