...
- Read `{SKILL_BASE}/resources/core/buying-signals.md` for signal ranking (#4 by purchase correlation)
- Read `{SKILL_BASE}/resources/core/signal-taxonomy.md` for adjacent vendor triggers (Category III, items 1-7) and integration signals
