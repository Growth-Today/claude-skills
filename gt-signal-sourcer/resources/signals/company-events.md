...
- Read `{SKILL_BASE}/resources/core/signal-taxonomy.md` for Category V: Firmographic Triggers (15 triggers)
- Read `{SKILL_BASE}/resources/core/buying-signals.md` for expansion signal (#5 by purchase correlation)
