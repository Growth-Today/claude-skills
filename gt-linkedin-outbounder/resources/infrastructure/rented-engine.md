...
| `gt-clay-builder` | Account enrichment, targeting, signal sourcing |
| `gt-list-builder` | Sales Navigator search → list → enrichment |
| `gt-buying-signal-sourcer` | Trigger feeds (job changes, hiring, post engagement) for warm outreach |
| `gt-cold-email-writer` | Multi-channel coordination |
