...
version: 1.0
updated: 2026-05-01
description: External reference library of HeyReach resources - guides, templates, and product mechanics - mapped to the gt-linkedin-outbounder sub-skills they inform. Use when looking for the source behind a benchmark, framework, or tool-specific workflow referenced elsewhere in this skill.
---
...
| Skill / file | Why |
|-------|-----|
| `gt-linkedin-outbounder` | Main skill - all embedding lives here |
| `gt-clay-builder` | HeyReach + Clay is the canonical enrichment-into-outreach pipeline |
| `gt-buying-signal-sourcer` | Source 1's micro-segmentation logic is a signal-sourcer concern |
| `gt-list-builder` | Source 1's Sales Nav "active in 30 days" filter is a list-building tactic |
