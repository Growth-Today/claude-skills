...
| Skill | Why |
|-------|-----|
| `gt-linkedin-outbounder` | Main skill - routing and sequence structure |
| `gt-buying-signal-sourcer` | Improve acceptance and reply rates with better signals |
| `gt-list-builder` | Fix low-acceptance issues caused by weak ICP fit |
| `gt-linkedin-content` | Sender profile and content layer that lifts every metric here |
| `gt-clay-builder` | Personalization data feeding M1 hooks |
