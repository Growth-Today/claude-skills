...
> "MCP just changed how AI connects to tools. Here's the 60-second GTM breakdown."

**The Number Lead:**
> "37 of the best-performing sales triggers to reach out at the right time."
> "12 AI automations that replaced manual work in our agency last quarter."

**The Breaking News:**
> "[Tool/Model] just released [feature]. Here's what GTM teams need to know."
> "BREAKING: [X] is changing how outbound works. Details 👇"

**The Death Declaration:**
> "The end for [legacy tool]?"
> "R.I.P. spray-and-pray outbound."
...
> "We built this ICP research system for [X]+ B2B clients. Here's how it works."

**The "How It Started" (Journey):**
> "How it started: [bad state with number]. How it's going: [good state with number]."
> "How it started: 1.2% reply rates. How it's going: 4.7%. Here's what changed."

**The Contrarian:**
> "[Common belief] is wrong. Here's why."
> "You don't need [expensive thing]. Here's what works instead."
> "Most [audience] are doing [X] wrong. Here's what we see across [X]+ clients."
...
> "We automated [X] in [timeframe]. Here's the step-by-step."
...
> "We've sent over [number] cold emails. These [X] [things] got us [result]. Comment '[KEYWORD]' below."

**The Resource Drop:**
> "Here are the [X] [things] that generated the most [result] for us."
> "[Specific bold claim]. Here's the exact [resource type]."

**The Case Study:**
> "We generated [X] [result] for a [client type]. Here's what we did step-by-step."
> "This [system/approach] added [metric] in [timeframe]. Here's the breakdown."
...
> "We're a Clay Enterprise partner. Here's the workflow we recommend first."

**Client result:**
> "We generated [X] meetings for a [ICP type] client in [timeframe]. Here's the system."
> "This campaign went from [bad metric] to [good metric] in [timeframe]. Here's what changed."

**Internal process:**
> "Here's every tool we use to run our Clay agency:"
> "We automated our entire [process] with Claude + Make.com. Here's how."

**Building in public:**
> "How we onboard a new GTM client in under [X] hours. Zero-touch."
> "We built [X] custom AI agents for our internal ops. Here's what they replaced."
