...
## Brigi, 170 posts analyzed (23K followers)
...
| Tier | What triggers it |
|---|---|
| S | stage-based rule reframes, tool-stack lists, a strong opinion |
| A | cold email frameworks, GTM-evolution reframes, resource giveaways |
| B | how-to breakdowns, "wrong question" contrarian |
| C | narrower tactical posts |
...
- Full by-follower-band benchmarks and levers: `performance-playbook.md`.
- Voice and word choice: `writing-guide.md`, `winning-words.md`.
- Re-run the tiers here when fresh data comes in.
