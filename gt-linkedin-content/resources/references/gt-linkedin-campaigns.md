...
> For cold outbound at scale — connection-request and DM sequences, multi-account "rented engine" setup, warmup protocols, and per-account daily limits — see the companion **gt-linkedin-outbound** skill (also open-source): https://www.growthtoday.co/claude-skills. This file covers the limits you need to stay safe while doing *organic* engagement; the outbound skill owns the campaign mechanics.
