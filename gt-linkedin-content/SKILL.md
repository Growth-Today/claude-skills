...
- **Social selling: converting the warm audiences your content builds** (profile viewers, followers, connections, engagers, plus the Sales Navigator and Expandi/Clay setup) → Read `{SKILL_BASE}/resources/social-selling/social-selling-campaigns.md`. For cold outreach to strangers, use the `gt-linkedin-outbounder` skill.
