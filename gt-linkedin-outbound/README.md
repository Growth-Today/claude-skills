...
A LinkedIn outbound strategy skill for Claude, built by [Nikola Siljanoski](https://www.linkedin.com/in/nikola-siljanoski/) at [Growth Today](https://www.growthtoday.co). A single orchestrator routes to 15 sub-skills covering connection requests, DM sequences, copywriting, personalization, rented-engine infrastructure, campaign strategy, follow-up discipline, and LinkedIn-first GTM.
